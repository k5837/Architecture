<template>
  <el-card margin:auto style="width:800px;height:580px; background-color:#eeeeee;">
    <el-row>
      <el-col :span="10">
        <div>
          <p>GPT</p>
            ...
            <el-col :span="8">
              <div class="button-container">
                    ...
                    <div style="flex: 1;">
                      <el-card
                        ...
                        <div class="scroll-container">
                          ...
                          <h4 style="margin-left: 10px; font-style: italic;">In general</h4>
                ...
                <el-popover placement="left-start">
                  <div style="display: flex;">
                    <div style="flex: 1;">
                      <el-card style="display:flex; width: 300px; height: 440px; position: fixed; top:8px; margin-left: -275px; border-radius:5px; font-size:16px;">
                        <p>Upload Image</p>
                        <div class="rectangle-container">
                          <div class="rectangle">
                            <i class="el-icon-plus" style="font-size: 200px; cursor: pointer;color:#D3D3D3" @click="handleImageUpload"
                              v-if="!imageUrl"></i>
                          ...
                          <div class="button-container1">
                            <el-button type="primary" @click="handleImageUpload" v-if="!imageUrl" style="margin-top: 20px;;">Choose</el-button>
                            <el-button type="success" @click="uploadToDALLE" v-if="imageUrl" style="margin:20px;">Upload</el-button>
                            <el-button type="danger" @click="deleteImage" v-if="imageUrl" style="margin-right:20px;">Delete</el-button>
                          </div>
                        </div>
      ...
      <el-col :span="14">
        <el-row>
          <div class="block" style="margin-left: 20px; margin-top: 10px; width:430px">
            <span class="demonstration">Artistic style</span>
            <span class="demonstration" style="margin-left: 210px;">Realistic style</span>
            <el-slider v-model="value1" style="margin:"></el-slider>
          </div>
        </el-row>
        <el-row>

          <div class="image-grid" style="width: 430px;height:450px;margin-left: 20px; margin-top: 10px;">
            <div v-for="(image, index) in generatedImages" :key="index" class="image-container">
              <!-- <div class="image-card"> -->
              <img :src="image" alt="Generated Image"
                style="width:200px;height:210px;border-radius: 5px;background-color: #D3D3D3;"
        ...
        <el-row>
          <div class="button-bar" style="position: relative;">
            <el-button style="width:30px; height:30px; padding: 0px 0px 0px 0px; margin:0px 0px 0px 0px;"
              v-for="(button, index) in buttons" :key="index" @click="selectImageByButton(index)"
              :disabled="selectedIndex === index">{{ button }}</el-button>
            <el-button @click="regenerateImages">Re-generate</el-button>

            <el-dropdown @command="changeOption">
              <span class="el-dropdown-link">
                Change
                <i class="el-icon-arrow-down el-icon--right"></i>
              </span>
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item command="changeView"
                  :disabled="selectedIndex === -1 || changedImages[selectedIndex]">Angles</el-dropdown-item>
                <el-dropdown-item command="changeTime"
                  :disabled="selectedIndex === -1 || changedImages[selectedIndex]">Time</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
            ...
            <el-dropdown @command="changeOption">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item command="changeLocal"
                  :disabled="selectedIndex === -1 || changedImages[selectedIndex]">Local</el-dropdown-item>
                <el-dropdown-item command="changeConcept"
                  :disabled="selectedIndex === -1 || changedImages[selectedIndex]">Concept</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
...
// sendMessage() {
  ...
  //   console.log('登录用户：', this.$store.state.userid)

  //   this.$axios.post('http://127.0.0.1/sendMessage', { userid, userInput })
  //     .then((response) => {
